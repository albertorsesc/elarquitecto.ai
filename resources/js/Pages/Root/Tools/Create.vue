    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 bg-background p-4">
            <div class="mb-6 flex items-center justify-between">
                <h1 class="animate-text-glow text-2xl font-bold text-glow">Nueva Herramienta</h1>
...
- Usa encabezados, listas, etc."
                    ...
                    <div class="border-t border-border/30 pt-4">
                        ...
                        >
                            ...
                            <span v-else>Crear Herramienta</span>
                        </button>
                    </div>
                </form>
            </div>
...
const submit = () => {
    form.post(route('root.tools.store'), {
