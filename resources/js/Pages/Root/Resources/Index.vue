    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 bg-background p-4">
            <div class="mb-6 flex items-center justify-between">
                <h1 class="animate-text-glow text-2xl font-bold text-glow">Resources</h1>
                <CyberLink :href="route('root.blog.resources.create')" variant="primary" size="md"> Create New Resource </CyberLink>
            </div>
