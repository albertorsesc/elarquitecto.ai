    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 bg-background p-4">
            <div class="mb-6 flex items-center justify-between">
                <h1 class="animate-text-glow text-2xl font-bold text-glow">Create Article</h1>
            ...
            <div class="glass-effect neon-border mx-auto w-full max-w-4xl rounded-xl p-6">
                <form @submit.prevent="submit" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <AnimatedInputBorder id="slug" v-model="form.slug" placeholder="article-slug" required />
