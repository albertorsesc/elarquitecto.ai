    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 bg-background p-4">
            <div class="mb-6 flex items-center justify-between">
                <h1 class="animate-text-glow text-2xl font-bold text-glow">Edit Article</h1>
            ...
            <div class="glass-effect neon-border mx-auto w-full max-w-4xl rounded-xl p-6">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <AnimatedInputBorder id="title" v-model="form.title" placeholder="Enter article title" required />
                        <p v-if="form.errors.title" class="mt-1 text-sm text-red-500">{{ form.errors.title }}</p>
                    </div>

                    <!-- Slug (read-only) -->
                    <div class="space-y-2">
                        <label for="slug" class="block text-sm font-medium text-foreground/80"> Slug </label>
                        <AnimatedInputBorder id="slug" v-model="form.slug" placeholder="article-slug" disabled class="opacity-70" required />
...
- Use headings, lists, etc."
                    ...
                    <div class="space-y-2">
                        ...
                        <AnimatedInputBorder id="original_url" v-model="form.original_url" placeholder="https://example.com/original-post" />
...
import { type Article, type BreadcrumbItem, type Category, type Tag } from '@/types';
...
const submit = () => {
    ...
    router.post(
        route('root.blog.articles.update', props.article.slug),
        {
            _method: 'put',
            title: form.title,
            body: form.body,
