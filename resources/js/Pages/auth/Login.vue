    ...
    <AuthBase title="" description="Accede a tu cuenta para explorar el futuro de la inteligencia artificial">
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
                ...
                <div class="flex items-center justify-between" :tabindex="3">
                    <Label for="remember" class="flex items-center space-x-3 text-foreground/80">
                        <Checkbox
                            ...
                            :tabindex="4"
                            class="border-white/20 data-[state=checked]:bg-primary data-[state=checked]:text-white"
                        />
                        <span>Recordarme</span>
                    </Label>
                </div>

                <Button type="submit" class="neon-border mt-4 w-full" :tabindex="4" :disabled="form.processing">
            ...
            <div class="text-center text-sm text-foreground/60">
                ...
                <TextLink :href="route('register')" :tabindex="5" class="text-primary transition-colors hover:text-primary/80"> Regístrate </TextLink>
            </div>
        </form>
    </AuthBase>
</template>
