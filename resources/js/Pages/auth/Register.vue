    ...
    <AuthBase title="" description="Crea tu cuenta y descubre el poder de la inteligencia artificial">
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-6">
                ...
                <Button type="submit" class="neon-border mt-2 w-full" tabindex="5" :disabled="form.processing">
            ...
            <div class="text-center text-sm text-foreground/60">
                ...
                <TextLink :href="route('login')" class="text-primary transition-colors hover:text-primary/80" :tabindex="6">
                    Iniciar sesión
                </TextLink>
            </div>
        </form>
