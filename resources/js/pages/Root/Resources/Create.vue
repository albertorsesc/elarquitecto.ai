    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4 bg-background">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-bold text-glow animate-text-glow">Create Resource</h1>
                <CyberLink :href="route('root.resources.index')" variant="outline" size="md">
                    Back to Resources
                </CyberLink>
            </div>

            <!-- Create Resource Form -->
            <div class="glass-effect  rounded-xl p-6 max-w-4xl mx-auto w-full">
