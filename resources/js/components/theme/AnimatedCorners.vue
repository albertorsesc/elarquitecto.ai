<template>
    <!-- Top Left Corner -->
    <div class="absolute left-0 top-0 h-12 w-12 animate-pulse-slow overflow-hidden">
    ...
    <!-- Top Right Corner -->
    <div class="absolute right-0 top-0 h-12 w-12 animate-pulse-slow overflow-hidden">
    ...
    <!-- Bottom Left Corner -->
    <div class="absolute bottom-0 left-0 h-12 w-12 animate-pulse-slow overflow-hidden">
    ...
    <!-- Bottom Right Corner -->
    <div class="absolute bottom-0 right-0 h-12 w-12 animate-pulse-slow overflow-hidden">
