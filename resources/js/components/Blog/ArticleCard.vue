    ...
    <div class="article-card-container group">
        ...
        <div class="article-card-image">
            ...
            <div class="article-card-gradient-overlay">
                <!-- Featured Badge -->
                <div v-if="article.is_featured" class="article-card-badge article-card-featured-badge">Featured</div>
            ...
            <div v-if="article.is_pinned" class="article-card-pin-ribbon">
                <div class="article-card-pin-ribbon-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-4 mt-1 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
